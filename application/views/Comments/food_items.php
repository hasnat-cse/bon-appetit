...
<div id="search_form"> 
    <form action="<?php echo site_url("comments/food_items"); ?>" method="post" >
            <table>
                <tr>
                <td><h4>Food</h4></td>
            ...
            if($foods){
                ...
                foreach ($foods as $food_item): ?>
                        ...
                        <tr  <?php if(($i%2)==0) 
                                            ...
                                            $i++;
                                            ?>>
                            <td><a href="<?php echo site_url() . '/comments/food_comments/'.$food_item['food_id'];?>"><?php echo $food_item['food']; ?></a></td>
                            <td><a href="<?php echo site_url() . '/comments/restaurant_comments/'.$food_item['restaurant_id'];?>"><?php echo $food_item['restaurant']; ?></td>
