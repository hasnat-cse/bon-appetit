...
<div id="search_form"> 
    <form action="<?php echo site_url("search/restaurants"); ?>" method="post" >
            <table>
                <tr>
            ...
            if($restaurants){
                ...
                foreach ($restaurants as $rest_item): ?>
                        ...
                        <tr  <?php if(($i%2)==0) 
                                            ...
                                            $i++;
                                            ?>>
                            <td><a href="<?php echo site_url() . '/search/restaurant_info/'.$rest_item['restaurant_id'];?>"><?php echo $rest_item['restaurant']; ?></a></td>
