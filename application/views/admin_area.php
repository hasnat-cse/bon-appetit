...
<div id="login_form_2">
	...
	<?php foreach ($query as $row): ?>
		<div id="edit_ticker" style="margin-top:13%;">	
            <img style="height: 85%;" src="<?php echo base_url()."$row->imglink"?>" alt="Restaurant Picture" />			
		</div>            
	...
	<div id="login_form_tail">
		...
		<fieldset>
				...
				echo form_open('admin/update_info');echo"</br>";
				echo form_input('name', set_value('name', $row->rname));echo"</br>";
				echo form_input('address', set_value('address', $row->address));echo"</br>";
				echo form_input('district', set_value('district', $row->district));echo"</br>";				
     ...
     <div id="login_form_3" style="margin-top:30%">
         <?php
                echo form_open_multipart('admin/change_pic'); 
