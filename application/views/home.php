...
<div id="maincontainer">
    ...
    <div id="sliderFrame">
        <div id="slider">
            ...
            <img src="<?php echo base_url();?>images/130307124701-large.jpg" alt="Pizza is good for different taste" />
            <img src="<?php echo base_url();?>images/Chicken-Reshmi-Kabab_113.jpg" alt="Kabab is delicious" />
            <img src="<?php echo base_url();?>images/1648_058_433_279_Hotel-Mont-Blanc-2.jpg" alt="Restaurant environment is also neccessary" />
            <img src="<?php echo base_url();?>images/1447760297_1370610008.jpg" alt="Fast food is good" />
            <img src="<?php echo base_url();?>images/thai_food.jpg" alt="Prawn Soup is fine" />
